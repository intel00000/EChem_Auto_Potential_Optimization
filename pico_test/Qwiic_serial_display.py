...
class HT16K33:
    ...
    def set_blink_rate(self, rate):
        ...
        self.write_data(bytearray([self.ALPHA_CMD_DISPLAY_SETUP | (blink_rate << 1) | self.ALPHA_DISPLAY_ON]))

    def display_on(self):
        self.write_data(bytearray([self.ALPHA_CMD_DISPLAY_SETUP | self.ALPHA_DISPLAY_ON]))

    def display_off(self):
        self.write_data(bytearray([self.ALPHA_CMD_DISPLAY_SETUP | self.ALPHA_DISPLAY_OFF]))
    ...
    def get_segments(self, displayChar):
        ...
        return char_map.get(displayChar, 0b00000000000000)  # Default to space if character not found
