...
def print_summary():
    ...
    rpm = round(pulse_count/46.058, 3)
    ...
    ) * 3300  # Convert 0-65535 ADC value to 0-3300 mV
    voltage_percentage = (
        voltage_mV / 2500
    ...
    print(f"Tach Output (Flow rate): {rpm} mL/Min")
    print(f"Speed Signal Voltage: {voltage_mV:.3f} mV ({voltage_percentage:.3f}%), calculated flow rate {126 * voltage_percentage / 100:.3f}")
    print("------------------------------------------------")
